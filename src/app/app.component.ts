...
export class AppComponent {
  ...
  showLayout(): boolean {
    ...
    const excludedRoutes = ['/', '/signin', '/signup', '/admin-dashboard', '/super-admin-dashboard', '/super-admin-clients', '/super-admin-client-details', '/super-admin-add-admin', '/super-admin-admins', '/super-admin-admin-details', '/super-admin-reports', '/clients', '/admin-locations', '/admin-location-details', '/admin-view-extinguisher', '/admin-add-extinguisher', '/admin-inspection-label', '/admin-assigned-inspections', '/admin-inventory', '/admin-inspectors', '/admin-compliance', '/admin-refills', '/admin-settings'];
