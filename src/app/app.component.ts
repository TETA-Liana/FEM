...
export class AppComponent {
  ...
  showLayout(): boolean {
    ...
    const excludedRoutes = ['/', '/signin', '/signup', '/admin-dashboard', '/clients', '/admin-locations', '/admin-location-details', '/admin-view-extinguisher', '/admin-add-extinguisher', '/admin-inspection-label', '/admin-assigned-inspections', '/admin-inventory', '/admin-inspectors', '/admin-compliance'];
